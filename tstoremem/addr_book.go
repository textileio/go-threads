...
var log = logging.Logger("threadstore")
...
func NewLogAddrBook() tstore.LogAddrBook {
...
func (mab *memoryAddrBook) LogsWithAddrs(t thread.ID) peer.IDSlice {
...
func (mab *memoryAddrBook) ThreadsFromAddrs() thread.IDSlice {
